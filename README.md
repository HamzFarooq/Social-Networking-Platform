...
Yeh ek simple console-based Social Network project hai C++ mein, jismein users signup, login, posts banatay hain, comments kartay hain aur dost bana saktay hain. Saari data file handling ke zariye save hoti hai.
...
- `users.txt` – Users ka data save karta hai (username, password, friends, friend requests)
- `posts.txt` – Posts aur unke comments save karta hai
